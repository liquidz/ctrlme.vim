...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_ctrlme#Text#TOML#import() abort
  ...
  execute join(['function! vital#_ctrlme#Text#TOML#import() abort', printf("return map({'parse': '', 'parse_file': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
